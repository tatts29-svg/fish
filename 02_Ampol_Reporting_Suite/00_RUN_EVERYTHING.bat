...
echo.
echo  [5/8] Tooling reports (exec, on-hire register, quarterly charges, utilisation, compliance)...
...
echo.
echo  Truth table - counting the key figures again straight from the exports...
