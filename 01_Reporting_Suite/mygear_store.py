...
/*  the scan code, directly under the picture and HALF ITS WIDTH.
    (Andrew, 4 Aug 2026: "lets half the barcode again.") At the full
    96px it was as big as the product photograph and left the right of
    the card empty under the words - a scan code is something you point
    a gun at, not the second-biggest thing on the screen.  */
.stcard.wide .stqr.s2{position:static;width:48px;height:48px;margin:0;
 padding:3px;border-radius:9px;box-shadow:none}
...
@media(min-width:560px){
  ...
  .stcard.wide .stqr.s2{width:66px;height:66px}
